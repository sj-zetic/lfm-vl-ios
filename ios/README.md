...
1. From the repository root, copy `.env.example` to `.env`, set
   `ZETIC_PERSONAL_KEY`, then generate the
...
2. Open `ios/ZeticMLangeLLMSample.xcodeproj`, set your signing team, select your
   device, and run.
